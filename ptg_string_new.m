% PTG_STRING_NUMBER
%
%   ptv_str=ptg_string_NUMBER(ptv_str_cat,ptv_str_num)
%
%   ptv_str = output string
%   ptv_str_cat = input category of string
%   ptv_str_num = input number of string
%
%   GUI function PTG_STRING_NUMBER is called from PTF_STRING
%   PTG_STRING_#NUM returns required string for GUI figures and uicontrol
%   objects in LANGUAGE_NAME



function ptv_str=ptg_string_NUMBER(ptv_str_cat,ptv_str_num)
...
switch ptv_str_cat
    ...
    case 0
        switch ptv_str_num
            otherwise
                ptv_str = 'SHORT_LANGUAGE_NAME - LANGUAGE_NAME';
        end
    ...
    case 2
          ...
          switch ptv_str_num
              ...
              case 3
                  ptv_str = ' PIDTOOL is already running!';
              case 4
    ...
    case 9
          ...
          switch ptv_str_num
              ...
              case 3
                  ptv_str = ' The time delay D have to be a non negative number!';
              case 4
                  ptv_str = ' Damping coeficient ksi_pe have to be a real positve number lower or equal 1!';
              case 5
                  ptv_str = ' File POMOC.HTML not found!';
              case 6
              ...
              case 47
                  ptv_str = ' In case PID or PD controller is tuned, time delay D has to be a positive number!';
              case 48
    ...
    case 11
          ...
          switch ptv_str_num
              ...
              case 2
                  ptv_str = 'Ziegler - Nichols method|Strejc method|Cohen - Coon method|Direct synthesis method using approximeted closed-loop model|Haalman method|Chien - Hrones - Reswick method (0% overshoot)|Chien - Hrones - Reswick method (20% overshoot)|Half dampping method|Rivera - Morari method|Rivera - Morari method (improved)|Minimum IAE method|Minimum ITAE method|Lopez IAE-ISE method|Astrom - Hagglund method (Ms = 1.4)|Astrom - Hagglund method (Ms = 2.0)';
              case 3
                  ptv_str = 'Ziegler - Nichols method|Strejc method |Cohen - Coon method|Direct synthesis method using approximeted closed-loop model|Chien - Hrones - Reswick method (0% overshoot)|Chien - Hrones - Reswick method (20% overshoot)|Half dampping method|Rivera - Morari method|Minimum IAE method|Minimum ITAE method|Lopez IAE-ISE method|Astrom - Hagglund method (Ms = 1.4)|Astrom - Hagglund method (Ms = 2.0)';
              case 4
                  ptv_str = 'Cohen - Coon method';
              case 5
                  ptv_str = 'Pole placement method|Naslin method';
              case 6
              ...
              case 15
                  ptv_str = ' Time constant of closed-loop model, T_CL>0.2Tn a (T_CL/Tu)>1.7';
              case 16
                  ptv_str = ' Maximal overshoot:';
              case 17
                  ptv_str = ' 0%| 5%| 10%| 15%| 20%| 25%| 30%| 35%| 40%| 45%| 50%';
              case 18
                  ptv_str = ' Time constant of closed-loop model, T_CL>0.2Tn a (T_CL/Tu)>0.25';
              case 19
